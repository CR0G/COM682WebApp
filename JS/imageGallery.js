...
const IUPS =
  "https://prod-22.francecentral.logic.azure.com:443/workflows/cafaac358a5144fe819211a0cddb8c68/triggers/When_an_HTTP_request_is_received/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2FWhen_an_HTTP_request_is_received%2Frun&sv=1.0&sig=JCjhYUf2_JeArwaRCr4eelRrvAvEe91WbreprA5ZHoE";
const RAI =
  "https://prod-27.francecentral.logic.azure.com:443/workflows/9eac1c2ca7f747cda19de30d3a01c313/triggers/When_an_HTTP_request_is_received/paths/invoke?api-version=2016-10-01&sp=%2Ftriggers%2FWhen_an_HTTP_request_is_received%2Frun&sv=1.0&sig=5sATFa5IQCmAOFv1qDdscT10IXNeSD_e31RV22O1SG8";
      ...
      $.each(data, function (_, val) {
        try {
          ...
          if (isVideo) {
            ...
            cards.push(`
              <div class="media-card" styles="height:445px;">
                <div class="media-thumb">
                  <img src="${fullUrl}"
                       alt="${safeLabel}"
